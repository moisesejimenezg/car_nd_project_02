...
ax1[0].set_title("Abs. Gra. Thr.", fontsize=20)
ax1[1].imshow(filtered, cmap="gray")
ax1[1].set_title("Color Thr.", fontsize=20)
ax2[0].imshow(dir_threshold, cmap="gray")
ax2[0].set_title("Dir. Gra. Thr.", fontsize=20)
ax2[1].imshow(combined, cmap="gray")
ax2[1].set_title("Combined", fontsize=20)
